    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <h4>En nuestra pagina tu puedes ver el contenido de tus materias y compartirlo con tus companheros.</h4>         
              ...
              <div class="team-player">
                <div class="card card-plain">
                  ...
                  <div class="card-footer justify-content-center">
                    ...
                    <img src="/img/brand/share.png" alt="Thumbnail Image" sizes="70x70" class="img-raised rounded-circle img-fluid">
                    </a>
                    @endauth
                  </div>
                </div>
