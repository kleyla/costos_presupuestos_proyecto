...
<head>
  ...
  <link rel="icon" type="image/png" href="{{asset('img/brand/studyIcon.png')}}">
    ...
    <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
        <div class="container">
            <div class="navbar-translate">
                ...
                Costos y Presupuestos Proyecto</a>
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <i class="material-icons"></i>Principal
                        </a>
                    </li>
                    @else
                    <li class="nav-item">
                        <a class="nav-link">
                        <i class="material-icons"></i>{{ Auth::User()->name }}
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    @yield('content')
        ...
        <footer class="footer">
            <div class="container">
                ...
                <ul>
                    <li>
                    <a href="https://www.uagrm.edu.com">
                        UAGRM
                    </a>
                    </li>
                ...
                <a href=" https://www.uagrm.edu.com " target="_blank">Karen Rodriguez</a>.
                </div>
            </div>
        </footer>
  <!--   Core JS Files   -->
